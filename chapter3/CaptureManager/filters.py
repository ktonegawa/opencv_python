...
def recolorRGV(src, dst):
    ...
    The source and destination images must both be in the BGR format.
...
def recolorCMV(src, dst):
    """Simulate conversation from BGR to CMV (cyan, magenta, value)
...
class VFuncFilter(object):
    """A filter that applies a function to V (Value) (or all ov BGR)."""
...
class BGRPortraCurveFilter(BGRCurveFilter):
    """A filter that aplies Portra-like curves to BGR."""
...
class BGRProviaCurveFilter(BGRCurveFilter):
    """A filter that aplies Provia-like curves to BGR."""
...
class BGRVelviaCurveFilter(BGRCurveFilter):
    """A filter that aplies Velvia-like curves to BGR."""
...
class BGRCrossProcessCurveFilter(BGRCurveFilter):
    """A filter that aplies cross-process-like curves to BGR."""
...
class VConvolutionFilter(object):
    """A filter that applies a convolution to V (value) (or all of BGR)."""
